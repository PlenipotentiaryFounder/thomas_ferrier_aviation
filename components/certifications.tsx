...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="relative py-32 overflow-hidden bg-secondary/50" ref={sectionRef}>
      {/* Background elements */}
      <div className="absolute inset-0 -z-10">
        ...
        <motion.div
          ...
          className="absolute -right-64 bottom-64 w-[30rem] h-[30rem] rounded-full bg-green-500/5 blur-3xl"
        />
      </div>
